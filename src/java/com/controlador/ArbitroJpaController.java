    ...
    public void create(Arbitro arbitro) throws RollbackFailureException, Exception {
        ...
        try {
            ...
            for (Partido partidoListPartido : arbitro.getPartidoList()) {
                Arbitro oldCentralOfPartidoListPartido = partidoListPartido.getCentral();
                partidoListPartido.setCentral(arbitro);
                partidoListPartido = em.merge(partidoListPartido);
                if (oldCentralOfPartidoListPartido != null) {
                    oldCentralOfPartidoListPartido.getPartidoList().remove(partidoListPartido);
                    oldCentralOfPartidoListPartido = em.merge(oldCentralOfPartidoListPartido);
                }
            }
            for (Partido partidoList1Partido : arbitro.getPartidoList1()) {
                Arbitro oldJuez1OfPartidoList1Partido = partidoList1Partido.getJuez1();
                partidoList1Partido.setJuez1(arbitro);
                partidoList1Partido = em.merge(partidoList1Partido);
                if (oldJuez1OfPartidoList1Partido != null) {
                    oldJuez1OfPartidoList1Partido.getPartidoList1().remove(partidoList1Partido);
                    oldJuez1OfPartidoList1Partido = em.merge(oldJuez1OfPartidoList1Partido);
                }
            }
            for (Partido partidoList2Partido : arbitro.getPartidoList2()) {
                Arbitro oldJuez2OfPartidoList2Partido = partidoList2Partido.getJuez2();
                partidoList2Partido.setJuez2(arbitro);
                partidoList2Partido = em.merge(partidoList2Partido);
                if (oldJuez2OfPartidoList2Partido != null) {
                    oldJuez2OfPartidoList2Partido.getPartidoList2().remove(partidoList2Partido);
                    oldJuez2OfPartidoList2Partido = em.merge(oldJuez2OfPartidoList2Partido);
                }
            }
            for (Partido partidoList3Partido : arbitro.getPartidoList3()) {
                Arbitro oldJuez3OfPartidoList3Partido = partidoList3Partido.getJuez3();
                partidoList3Partido.setJuez3(arbitro);
                partidoList3Partido = em.merge(partidoList3Partido);
                if (oldJuez3OfPartidoList3Partido != null) {
                    oldJuez3OfPartidoList3Partido.getPartidoList3().remove(partidoList3Partido);
                    oldJuez3OfPartidoList3Partido = em.merge(oldJuez3OfPartidoList3Partido);
                }
            }
            utx.commit();
        } catch (Exception ex) {
        ...
        try {
            ...
            for (Partido partidoListOldPartido : partidoListOld) {
                if (!partidoListNew.contains(partidoListOldPartido)) {
                    ...
                    illegalOrphanMessages.add("You must retain Partido " + partidoListOldPartido + " since its central field is not nullable.");
                }
            }
            for (Partido partidoList1OldPartido : partidoList1Old) {
                if (!partidoList1New.contains(partidoList1OldPartido)) {
                    ...
                    illegalOrphanMessages.add("You must retain Partido " + partidoList1OldPartido + " since its juez1 field is not nullable.");
                }
            }
            for (Partido partidoList2OldPartido : partidoList2Old) {
                if (!partidoList2New.contains(partidoList2OldPartido)) {
                    ...
                    illegalOrphanMessages.add("You must retain Partido " + partidoList2OldPartido + " since its juez2 field is not nullable.");
                }
            }
            for (Partido partidoList3OldPartido : partidoList3Old) {
                if (!partidoList3New.contains(partidoList3OldPartido)) {
                    ...
                    illegalOrphanMessages.add("You must retain Partido " + partidoList3OldPartido + " since its juez3 field is not nullable.");
                }
            }
            if (illegalOrphanMessages != null) {
            ...
            for (Partido partidoListNewPartido : partidoListNew) {
                if (!partidoListOld.contains(partidoListNewPartido)) {
                    Arbitro oldCentralOfPartidoListNewPartido = partidoListNewPartido.getCentral();
                    partidoListNewPartido.setCentral(arbitro);
                    partidoListNewPartido = em.merge(partidoListNewPartido);
                    if (oldCentralOfPartidoListNewPartido != null && !oldCentralOfPartidoListNewPartido.equals(arbitro)) {
                        oldCentralOfPartidoListNewPartido.getPartidoList().remove(partidoListNewPartido);
                        oldCentralOfPartidoListNewPartido = em.merge(oldCentralOfPartidoListNewPartido);
                    }
                }
            }
            for (Partido partidoList1NewPartido : partidoList1New) {
                if (!partidoList1Old.contains(partidoList1NewPartido)) {
                    Arbitro oldJuez1OfPartidoList1NewPartido = partidoList1NewPartido.getJuez1();
                    partidoList1NewPartido.setJuez1(arbitro);
                    partidoList1NewPartido = em.merge(partidoList1NewPartido);
                    if (oldJuez1OfPartidoList1NewPartido != null && !oldJuez1OfPartidoList1NewPartido.equals(arbitro)) {
                        oldJuez1OfPartidoList1NewPartido.getPartidoList1().remove(partidoList1NewPartido);
                        oldJuez1OfPartidoList1NewPartido = em.merge(oldJuez1OfPartidoList1NewPartido);
                    }
                }
            }
            for (Partido partidoList2NewPartido : partidoList2New) {
                if (!partidoList2Old.contains(partidoList2NewPartido)) {
                    Arbitro oldJuez2OfPartidoList2NewPartido = partidoList2NewPartido.getJuez2();
                    partidoList2NewPartido.setJuez2(arbitro);
                    partidoList2NewPartido = em.merge(partidoList2NewPartido);
                    if (oldJuez2OfPartidoList2NewPartido != null && !oldJuez2OfPartidoList2NewPartido.equals(arbitro)) {
                        oldJuez2OfPartidoList2NewPartido.getPartidoList2().remove(partidoList2NewPartido);
                        oldJuez2OfPartidoList2NewPartido = em.merge(oldJuez2OfPartidoList2NewPartido);
                    }
                }
            }
            for (Partido partidoList3NewPartido : partidoList3New) {
                if (!partidoList3Old.contains(partidoList3NewPartido)) {
                    Arbitro oldJuez3OfPartidoList3NewPartido = partidoList3NewPartido.getJuez3();
                    partidoList3NewPartido.setJuez3(arbitro);
                    partidoList3NewPartido = em.merge(partidoList3NewPartido);
                    if (oldJuez3OfPartidoList3NewPartido != null && !oldJuez3OfPartidoList3NewPartido.equals(arbitro)) {
                        oldJuez3OfPartidoList3NewPartido.getPartidoList3().remove(partidoList3NewPartido);
                        oldJuez3OfPartidoList3NewPartido = em.merge(oldJuez3OfPartidoList3NewPartido);
                    }
                }
            }
            utx.commit();
    ...
    public void destroy(Integer id) throws IllegalOrphanException, NonexistentEntityException, RollbackFailureException, Exception {
        ...
        try {
            ...
            for (Partido partidoListOrphanCheckPartido : partidoListOrphanCheck) {
                ...
                illegalOrphanMessages.add("This Arbitro (" + arbitro + ") cannot be destroyed since the Partido " + partidoListOrphanCheckPartido + " in its partidoList field has a non-nullable central field.");
            }
            ...
            for (Partido partidoList1OrphanCheckPartido : partidoList1OrphanCheck) {
                ...
                illegalOrphanMessages.add("This Arbitro (" + arbitro + ") cannot be destroyed since the Partido " + partidoList1OrphanCheckPartido + " in its partidoList1 field has a non-nullable juez1 field.");
            }
            ...
            for (Partido partidoList2OrphanCheckPartido : partidoList2OrphanCheck) {
                ...
                illegalOrphanMessages.add("This Arbitro (" + arbitro + ") cannot be destroyed since the Partido " + partidoList2OrphanCheckPartido + " in its partidoList2 field has a non-nullable juez2 field.");
            }
            ...
            for (Partido partidoList3OrphanCheckPartido : partidoList3OrphanCheck) {
                ...
                illegalOrphanMessages.add("This Arbitro (" + arbitro + ") cannot be destroyed since the Partido " + partidoList3OrphanCheckPartido + " in its partidoList3 field has a non-nullable juez3 field.");
            }
            if (illegalOrphanMessages != null) {
                throw new IllegalOrphanException(illegalOrphanMessages);
            }
